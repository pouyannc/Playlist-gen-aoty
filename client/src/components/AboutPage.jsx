    ...
    <Box sx={{ textAlign: 'left', m: 6, mx: 15, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '70vh' }}>
      <Box>
        ...
        <Typography sx={{ minWidth: 100, m: 4 }} variant="subtitle1">
          ...
          The generated playlist is automatically added to your Spotify if you have linked your account. Easily discover new tracks and artists you love through the AOTY Playlist Gen and the effort of music lovers at AOTY.
        </Typography>
      </Box>
      <Box>
