    ...
    <Box sx={{ textAlign: 'left', m: 6, mx: 15, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '70vh' }}>
      <Box>
        ...
        <Typography sx={{ minWidth: 100, m: 4 }} variant="subtitle1">
          ...
          Using data from community reviews over at AOTY <a href="https://www.albumoftheyear.org/">(albumoftheyear.org)</a>, this app generates a playlist of the hottest albums that match your preffered criteria.
      ...
      <Box>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, justifyContent: 'center' }}>
          ...
          <Box sx={{ width: 20 }}>
            <a href="https://github.com/pouyannc"><FaGithub size={40} /></a>
          </Box>
        </Box>
